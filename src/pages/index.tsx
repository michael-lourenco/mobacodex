    ...
    <>
      ...
      <div className="flex h-screen w-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            <h1 className="mt-6 text-center text-3xl font-extrabold logo text-gray-900">MOBA CODEX API</h1>
          </div>
          ...
          {session ? (  
            ...
            <>
              <h2 className='block text-center text-1xl text-gray-400 '>GET DATA ABOUT <span className='text-gray-800'> CHAMPIONS </span> AND <span className='text-gray-800'> ITEMS </span> OF <span className='text-gray-800'>LOL</span>
              </h2>
              <div className="mt-8 space-y-6">
                <div>
